...
vio_df$sip <- ifelse(vio_df$week >= 10 & vio_df$year == 2020, 1, 0)

vio_df$sip <- ifelse(vio_df$week_start >= as.Date("2020-03-05")-weeks(1), 1, 0)
...
vio_df$sip_all <- ifelse(vio_df$week >= 10, 1, 0)
```
...
vio_df %<>%
  mutate(r_neg8 = ifelse(week == 2, 1, 0),
         r_neg7 = ifelse(week == 3, 1, 0),
         r_neg6 = ifelse(week == 4, 1, 0),
         r_neg5 = ifelse(week == 5, 1, 0),
         r_neg4 = ifelse(week == 6, 1, 0),
         r_neg3 = ifelse(week == 7, 1, 0),
         r_neg2 = ifelse(week == 8, 1, 0),
         r_neg1 = ifelse(week == 9, 1, 0),
         r_0 = ifelse(week == 10, 1, 0),
         r_1 = ifelse(week == 11, 1, 0),
         r_2 = ifelse(week == 12, 1, 0),
         r_3 = ifelse(week == 13, 1, 0),
         r_4 = ifelse(week == 14, 1, 0),
         r_5 = ifelse(week == 15, 1, 0),
         r_6 = ifelse(week == 16, 1, 0),
         r_7 = ifelse(week == 17, 1, 0),
         r_not = ifelse(week == 1 | week >= 18, 1,0))

#run event study regression
speed_lm <- lm(violations ~ r_neg8 + r_neg7 + r_neg6 + r_neg5 + r_neg4 + r_neg3 + r_neg2 + r_neg1 + 
                    r_0 + r_1 + r_2 + r_3 + r_4 + r_5 + r_6 + r_7, data = vio_df)
